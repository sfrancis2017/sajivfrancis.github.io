---
title: "MCP Is a Librarian, A2A Is a Relay Team"
subtitle: What building a five-agent video pipeline taught me about how AI systems coordinate, and why the pacing gap between the two protocols is the whole point.
...
Here's the confession. The AI parts? Smooth, almost suspiciously so. The thing that ate a full day was the *dashboard*, a tool called **n8n** that I used to watch the crew work, so I could see each hand-off happen live.
