---
title: "Grounded Review: Checking My Writing Against My Own Code"
subtitle: "AI-assisted publishing with a review gate: every claim checked against the actual repos before it ships."
...
Here's the loop. One Cloudflare Worker, the chat-worker, handles all read/write to DRAFTS_KV, with owner-only access enforced by CHAT_TOKEN.
