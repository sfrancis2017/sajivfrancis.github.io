...
Cut this section entirely, or collapse it to a single labeled list and remove the duplicate paragraph from "Why Not a Commercial Solution". The stack is fully described in both the preceding prose section and the diagrams — stating it a third time in its own section adds no new information.
