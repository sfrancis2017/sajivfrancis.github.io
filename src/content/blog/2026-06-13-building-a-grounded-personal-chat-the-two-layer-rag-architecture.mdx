...
subtitle: "Why I moved away from full-document ingestion and built a retrieval system with a library for humans and a worker for the LLM."
...
```
This post documents the architecture behind chat.sajivfrancis.com. Both layers are under active development — the current-state diagram reflects what's running now; the target state is what I'm building toward.
